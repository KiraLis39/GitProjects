...
//					System.out.println("CLOSING PREVIOUS MUS...");
	...
	public static void playBackg(String trackName) {
...
//					System.out.println("CLOSING PREVIOUS MUS...");
	...
	public static void playVoice(String trackName) {
	...
	public float getGlobalMusVolume(int band) {return (float) (Math.log(musicVolume) / Math.log(2) * 6.0f);}

	public static void nextMusic() {
		playMusic(((File) musicMap.values().toArray()[musicMap.size()]).getName(), true);
	}
}