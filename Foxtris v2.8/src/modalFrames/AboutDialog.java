...
public class AboutDialog extends JDialog implements KeyListener {
	...
	private FoxSpritesCombiner ubon = new FoxSpritesCombiner();
	...
	public AboutDialog(JFrame parent) throws Exception {
		...
		setTitle("Об игре:");
		setIconImage(ResourceManager.getBufferedImage("gameIcon"));
...
//		Media.nextMusicPlay();
	...
	private void init() throws Exception {
		bAbout = ResourceManager.getBufferedImage("bAbout");
		backSkyBuffer = ResourceManager.getBufferedImage("backAbout");
		middleStarsBuffer = ResourceManager.getBufferedImage("starsAbout");
		...
		sp = ubon.addSpritelist("bAbout", bAbout, 2, 2);
	}
