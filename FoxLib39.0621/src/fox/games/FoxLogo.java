		...
		logoFrame = new JFrame() {
			...
			private void drawText(Graphics2D g2D) {
				if (text != null && !text.isBlank()) {
					...
					g2D.setFont(FoxFontBuilder.setFoxFont(FONT.ARIAL_NARROW, 22, true));
...

			{
				...
				InputAction.add("logo", this);
				InputAction.set("logo", "stop", breakKey, 0, new AbstractAction() {
					@Override	public void actionPerformed(ActionEvent arg0) {finalLogo();}
				});
