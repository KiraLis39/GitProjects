...
//	private static SimpleDateFormat dateFormat = new SimpleDateFormat("HH:mm:ss");
	...
	private Map<String, ClientHandler> clientsMap = new LinkedHashMap<String, ClientHandler>();
	...
	private final int PORT = 13900, MAX_CLIENTS = 32;;
...
//		MonitorFrame.toConsole("Server thread starts...");		
	...
	public synchronized String getIP() {
		try {return Inet4Address.getLocalHost().getHostAddress();
		} catch (UnknownHostException e) {return null;}
	}
	
	public synchronized String getHostName() {
		try {return Inet4Address.getLocalHost().getCanonicalHostName();
		} catch (UnknownHostException e) {return null;}
	}
	
	public synchronized int getPort() {return sSocket.getLocalPort();}
	
	public synchronized boolean isNetAccessible() {
	...
	public synchronized int getMaxClientsAllowed() {return MAX_CLIENTS;}

	public synchronized String getFormatTime(long millis) {return dateFormat.format(millis);}

	public int getConnectionsCount() {return clientsMap.size();}	
	public boolean getConnectionAlive() {return serverConnectionThread != null && serverConnectionThread.isAlive() && !serverConnectionThread.isInterrupted();}
	...
	public synchronized boolean containsClient(String clientName) {return clientsMap.containsKey(clientName);}
}